...
*load2
[position layer=message5 page=back visible=true opacity=255 top=0 height=640 left=0 width=960 marginl=0 margint=0 marginr=0 marginb=0 frame="loaddiban.jpg"]
...
[locate x=40 y=97][button normal="kuang1" over="kuang2" storage="load.ks" target=*读取 exp="tf.存档编号=(f.当前load页-1)*8"]
[locate x=40 y=210][button normal="kuang1" over="kuang2" storage="load.ks" target=*读取 exp="tf.存档编号=(f.当前load页-1)*8+1"]
[locate x=40 y=325][button normal="kuang1" over="kuang2" storage="load.ks" target=*读取 exp="tf.存档编号=(f.当前load页-1)*8+2"]
[locate x=40 y=437][button normal="kuang1" over="kuang2" storage="load.ks" target=*读取 exp="tf.存档编号=(f.当前load页-1)*8+3"]
[locate x=448 y=97][button normal="kuang1" over="kuang2" storage="load.ks" target=*读取 exp="tf.存档编号=(f.当前load页-1)*8+4"]
[locate x=448 y=210][button normal="kuang1" over="kuang2" storage="load.ks" target=*读取 exp="tf.存档编号=(f.当前load页-1)*8+5"]
[locate x=448 y=325][button normal="kuang1" over="kuang2" storage="load.ks" target=*读取 exp="tf.存档编号=(f.当前load页-1)*8+6"]
[locate x=448 y=437][button normal="kuang1" over="kuang2" storage="load.ks" target=*读取 exp="tf.存档编号=(f.当前load页-1)*8+7"]
...
[询问窗口 text=&tf.询问对话 storage=load.ks cancel=*cancel ok=*确定读取]
[endif]
